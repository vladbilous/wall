    ...
    <section class="background-color-black">
        <div class="wall block-slider">
            <div class="slider row1">
                ...
                <div><img src="<?php echo get_template_directory_uri() ?>/img/Banner_1.jpg" alt=""/></div>
                <div><img src="<?php echo get_template_directory_uri() ?>/img/Banner_2.jpg" alt=""/></div>
                <div><img src="<?php echo get_template_directory_uri() ?>/img/Banner_3.jpg" alt=""/></div>
...
<!--    </section>-->
    ...
    <section class="background-color-00131b">
        <div class="wall">
            <div class="row2-new" style="color: white">
                <div class="row2__big-img1">
                    <img src="<?php echo get_template_directory_uri() ?>/img/img-big.png" alt=""/>
                </div>
                <div class="row2__nember-text">
                    ...
                    <div class="row2-new__block-table">
                    <div class="line-vertical"></div>
                    ...
                    <table >
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="row2__text"><?php pll_e( "club2" ); ?></span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="row2__text"><?php pll_e( "club3" ); ?></span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="row2__text"><?php pll_e( "club4" ); ?></span>
                            </td>
                        </tr>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="row2__text"><?php pll_e( "club5" ); ?></span>
                            </td>
                        </tr>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="row2__text"><?php pll_e( "club6" ); ?></span>
                            </td>
                        </tr>
                    </table>
...
<!--                        <hr class="row3__block1-hr">-->
                        ...
                        <img class="arr-bottom__block1" src="<?php echo get_template_directory_uri() ?>/img/arrow-bottom-progress.png" alt=""/>

                        <p class="progress-block1-desc">
                            <?php pll_e( "progress-block1-desc" ); ?>
                            <br>

                            <img class="arr-top1" src="<?php echo get_template_directory_uri() ?>/img/arrow-top-progress.png" alt=""/>
                    ...
                    <div class="row3__block2">
                        ...
                        <img class="arr-bottom__block2" src="<?php echo get_template_directory_uri() ?>/img/arrow-bottom-progress.png" alt=""/>

                        <p class="progress-block2-desc">
                            <?php pll_e( "progress-block2-desc" ); ?>
                            <br>

                            <img class="arr-top2" src="<?php echo get_template_directory_uri() ?>/img/arrow-top-progress.png" alt=""/>
                    ...
                    <div class="row3__block3">
                        ...
                        <img class="arr-bottom__block3" src="<?php echo get_template_directory_uri() ?>/img/arrow-bottom-progress.png" alt=""/>

                        <p class="progress-block3-desc">
                            <?php pll_e( "progress-block3-desc" ); ?>
                            <br>
                            <img class="arr-top3" src="<?php echo get_template_directory_uri() ?>/img/arrow-top-progress.png" alt=""/>
        ...
        <div class="wall">
            <div class="row4">
                ...
                <div class="row4__blocks">
                    <div class="row4__block r4b1">
                        <img src="<?php echo get_template_directory_uri() ?>/img/build_kompany.png" alt=""/>
                        <h3 class="r4b1-title"><?php pll_e( "cooperation-block1-title" ); ?></h3>

                        <p class="row4__text1">
                            <?php pll_e( "cooperation-block1-desc" ); ?>
                        </p>
                    </div>
                    <div class="row4__block r4b2">
                        <img src="<?php echo get_template_directory_uri() ?>/img/bank.png" alt=""/>
                        <h3 class="r4b2-title"><?php pll_e( "cooperation-block2-title" ); ?></h3>
...
<!--                </div>-->
<!--                <div class="row4__blocks">-->
                    <div class="row4__block r4b3">
                        <img src="<?php echo get_template_directory_uri() ?>/img/agro-company.png" alt=""/>
                        <h3 class="r4b3-title"><?php pll_e( "cooperation-block3-title" ); ?></h3>
                    ...
                    <div class="row4__block r4b4 row4__block2-last">
                        <img src="<?php echo get_template_directory_uri() ?>/img/international_institutions.png" alt=""/>
                        <h3 class="r4b4-title"><?php pll_e( "cooperation-block4-title" ); ?></h3>
    ...
    <section class="background-color-black row5">
        ...
        <div class="wall">
            <h1 class="title">
                <?php pll_e( "rule-title" ); ?>
                <img class="row5__arr-bottom" src="<?php echo get_template_directory_uri() ?>/img/arrow-bottom-progress.png" alt=""/>
                <img class="row5__arr-top" src="<?php echo get_template_directory_uri() ?>/img/arrow-top-orrange.png" alt=""/>
            </h1>
        </div>
        <div class="wall">
            <table>
        ...
        <div class="wall">
            <div class="row6">
                <div class="row6__title">
                    ...
                    <img class="arrow-bottom" src="<?php echo get_template_directory_uri() ?>/img/arrow-top.png" alt=""/>
                    <img  class="arrow-top" src="<?php echo get_template_directory_uri() ?>/img/arrow-bottom.png" alt=""/>
                </div>
...
<!--                </div>-->
    ...
    <section class="background-color-black news"  id="news">
        <div class="wall row11">
            <h2><?php pll_e( "news-title" ); ?></h2>

            <div class="row10__slider " style="color: red">
                <?php
                ...
                foreach ( $recent_posts as $post ) {
                    ...
                    $imgBackground =  get_the_post_thumbnail_url( $post->ID, 'full' );

                    echo '
                        <div>
                            <div class="row11__text-img" style=" background-image: linear-gradient( rgb(0 0 0 / 83%), rgb(0 0 0 / 78%) ), url(' . $imgBackground . ')  ">
...
<!--            <div class="row11__dots">-->
<!--                <img src=" '. get_template_directory_uri().'/img/dots1.png  " alt="" />-->
<!--                <img src=" '. get_template_directory_uri().'/img/dots1.png  " alt="" />-->
<!--                <img src=" '. get_template_directory_uri().'/img/dots1.png  " alt="" />-->
<!--            </div>-->
...
<!--            </div>-->
    ...
    <section class="background-color-00131b" id="contacts">
        <div class="wall">
